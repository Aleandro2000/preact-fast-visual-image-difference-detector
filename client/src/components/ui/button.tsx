...
export function Button({ class: className, variant, size, type, ...props }: ButtonProps) {
  return <button type={type} class={cn(buttonVariants({ variant, size }), className)} {...props} />;
}
